...
(function() {
    ...
    var games = [
        ...
        { id: '011-pong',       name: '🏓 Pong 对战',  short: 'Pong',    how: '经典乒乓对战！可单人打 AI 或双人同屏对战。<br>球击中挡板的位置决定反弹角度，先得 7 分者获胜。<br><b>1P</b>：W/S 控制左挡板 | <b>2P</b>：玩家1用W/S，玩家2用↑/↓' },
        { id: '012-invaders',   name: '🚀 太空侵略者', short: '太空侵略者', how: '经典街机射击游戏！消灭外星人军团，防止它们降落。<br>⬅➡ 移动 | 空格射击 | 敌人会越来越快。<br>消灭全部敌人进入下一波，波次越高难度越大。' },
        { id: '013-sokoban',    name: '📦 推箱子',     short: '推箱子',   how: '经典逻辑游戏！把箱子推到目标点。<br>只能推不能拉，需要仔细规划路线。<br>10 个精心设计的关卡，支持撤销操作。' },
        { id: '014-fruit',      name: '🔪 水果忍者',   short: '水果忍者', how: '滑动屏幕切割水果！一次切多个水果获得连击加分。<br>⚫ 黑色炸弹绝对不能切！<br><b>手机</b>：手指滑动切割 | <b>桌面</b>：鼠标拖拽切割' },
        { id: '015-td',         name: '🏰 塔防',       short: '塔防',     how: '策略塔防！在路径旁建造防御塔阻止敌人到达终点。<br>三种塔：🏹箭塔(快/单攻) ❄️冰塔(减速) 💣炮塔(范围伤害)<br>点击已有塔升级，15波敌人越来越强。' },
        { id: '016-reaction',   name: '⚡ 反应测试',    short: '反应测试', how: '测试你的反应速度！三种模式：<b>简单</b>（等绿色点击）、<b>选择</b>（看准颜色点击）、<b>连击</b>（10秒内尽可能多点）。<br>统计最佳/平均/最近反应时间，可视化历史记录条。' },
        { id: '017-typing',     name: '⌨️ 打字游戏',    short: '打字',     how: '单词从天而降，在它们落地前输入正确单词消除！<br>输入后按空格提交，WPM 实时统计。<br>速度随得分递增，5条命用完即结束。' },
        { id: '018-maze',       name: '🏛️ 迷宫探索',    short: '迷宫',     how: 'DFS 算法生成随机迷宫，从🟢走到🔴出口。<br>方向键/WASD 移动，三步难度：15×15 / 21×21 / 31×31。<br>可选迷雾模式（仅显示周围3格）。' },
        { id: '019-whack',      name: '🔨 打地鼠',      short: '打地鼠',   how: '经典打地鼠！30秒内尽可能多地击中冒出的地鼠。<br>金色⭐地鼠值3分，普通🐹地鼠值1分。<br>连击不中断可保持 combo 加成。' },
        { id: '020-match3',     name: '💎 消消乐',      short: '消消乐',   how: '经典三消游戏！点击两个相邻宝石交换位置。<br>三个或以上相同宝石连成一线即消除，<br>消除后上方宝石下落填充，可能触发连续消除。' },
    ];
